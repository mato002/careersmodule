...
<head>
    ...
    <meta name="description" content="Application Status - {{ $generalSettings->company_name ?? 'Company' }}">
    <meta name="keywords" content="careers, jobs, application status, {{ $generalSettings->company_name ?? 'Company' }}">
    <title>Application Status - {{ $generalSettings->company_name ?? 'Company' }}</title>
