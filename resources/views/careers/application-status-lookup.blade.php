...
<head>
    ...
    <meta name="description" content="Check your job application status - {{ $generalSettings->company_name ?? 'Company' }}">
    <meta name="keywords" content="careers, jobs, application status, {{ $generalSettings->company_name ?? 'Company' }}">
    <title>Check Application Status - {{ $generalSettings->company_name ?? 'Company' }}</title>
