...
@section('header-description', 'Complete your personal information and bio data')

@section('content')
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 class="text-xl font-bold text-gray-900">Bio Data Form</h2>
            <p class="text-sm text-gray-600 mt-1">Please complete all required fields to finalize your profile.</p>
        </div>

        <form method="POST" action="{{ route('candidate.biodata.update') }}" class="p-6 space-y-8">
            @csrf
            @method('PATCH')

            <!-- Personal Employment Data -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Personal Employment Data</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="national_id" class="block text-sm font-medium text-gray-700 mb-1">Identity Number <span class="text-red-500">*</span></label>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="text-sm font-semibold text-gray-900 mb-3">Home Physical Address</h4>
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Marital Status & Family</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="spouse_fields" style="{{ old('marital_status', $candidate->marital_status) === 'married' ? '' : 'display: none;' }}">
                    ...
                    <div id="spouse_phone_fields" style="{{ old('marital_status', $candidate->marital_status) === 'married' ? '' : 'display: none;' }}">
                        <label for="spouse_phone" class="block text-sm font-medium text-gray-700 mb-1">Spouse Phone Number</label>
                        <input type="text" id="spouse_phone" name="spouse_phone" value="{{ old('spouse_phone', $candidate->spouse_phone) }}" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                        @error('spouse_phone')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
            ...
            <!-- Parents' Information -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Parents' Information</h3>
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Health and Emergency Contact</h3>
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Educational Qualification</h3>
            ...
            <!-- Special Skills -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Special Skills</h3>
            ...
            <!-- Next of Kin -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Next of Kin</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="next_of_kin_address" name="next_of_kin_address" rows="2" 
                                  ...
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">{{ old('next_of_kin_address', $candidate->next_of_kin_address) }}</textarea>
            ...
            <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
                <a href="{{ route('candidate.dashboard') }}" class="px-6 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors font-semibold">
                    Cancel
                </a>
