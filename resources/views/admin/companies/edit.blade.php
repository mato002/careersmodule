...
@section('header-description', 'Update company information and subscription settings.')
        ...
        <form method="POST" action="{{ route('admin.companies.update', $company) }}">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-slate-200">
                    ...
                    <a href="{{ route('admin.companies.show', $company) }}" class="px-6 py-3 border border-slate-200 text-slate-600 rounded-xl hover:bg-slate-50 transition-colors font-semibold">
                        Cancel
                    </a>
                </div>
            </div>
